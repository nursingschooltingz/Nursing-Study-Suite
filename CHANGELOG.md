...
Implements the v15.6 brief. Items 1, 2, 3, 5, 6, and 7 are done; 4 and 8 are not started.
...
Harness 98 → 210 assertions. `Prompts.md` regenerated from live bytes (its `NCLEX_GEN_PROMPT` section was still v4.1 after the v15.5 bump).
