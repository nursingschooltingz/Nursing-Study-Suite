...
The full prompts behind the Knowledge Base builder, flashcard transcriber, Anki Generator, Priority Analyzer, NCLEX Extractor, NCLEX Generator, Case Study Generator, and the item-quality auditor, **extracted verbatim from the shipped v17.2 file** (spliced programmatically, not retyped — byte-identical to what the app sends).
...
## Case item repair builder (v17.2)
