...
**Published release: v17.3.** [Download the HTML](https://github.com/nursingschooltingz/Nursing-Study-Suite/releases/download/v17.3/Nursing-Study-Suite.v17.3.html) or open the [repository HTML](Nursing-Study-Suite%20v17.3.html). This release carries the 2026-09-23 production-review fixes: the settings drawer no longer steals keyboard focus (a v17.0 regression), study views stop re-rendering markdown on every keystroke, browser saves store the Knowledge Base once instead of twice, generated links open in a new tab, the Knowledge Base build can run two chunks at once, model settings persist across reloads, and React moves to 18.3.1. See the [release verification record](docs/reviews/v17.3-release.md).
