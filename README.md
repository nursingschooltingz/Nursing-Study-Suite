...
Turn your lecture PDFs and PowerPoints into a complete, source-cited study system: a structured knowledge base, prioritized study guides, tagged Anki flashcards, NCLEX-style practice questions, and unfolding clinical case studies — all generated from **your own course materials**, with every fact carrying its source file and page or slide range and a quote check against the extracted text.
...
**Published release: v17.4.** [Download the HTML](https://github.com/nursingschooltingz/Nursing-Study-Suite/releases/download/v17.4/Nursing-Study-Suite.v17.4.html) or open the [repository HTML](Nursing-Study-Suite%20v17.4.html). This release carries the 2026-09-24 production-review fixes: an unverified calculation answer is disclosed in every case export, NCLEX extraction keeps the union of both pairing passes, rejects malformed records instead of crashing and reports whether a run was complete, every batch tool stops on a provider wait or a permanent failure instead of sending more requests, Anki refuses a factless Knowledge Base, Priority keeps streamed text after a failure, and DOMPurify moves to 3.4.16. See the [release verification record](docs/reviews/v17.4-release.md). The previous release, v17.3, carried the 2026-09-23 review fixes: settings-drawer focus, memoized study views, single-copy browser saves, new-tab links, an opt-in second Knowledge Base lane, persisted model settings and React 18.3.1.
