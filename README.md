...
**v16.2 release:** [Download the single HTML file](https://github.com/nursingschooltingz/Nursing-Study-Suite/releases/download/v16.2/Nursing-Study-Suite.v16.2.html). Anki now defaults to Flash / Medium and includes editable source links, conservative tag normalization, clearer review warnings, and source-check reports with explicit target and Text/Extra records. Existing saved profiles stay intact; choose **Use recommended Anki profile** to update yours. Save the file, then open it in your browser.
