...
All eleven hashes remained unchanged through the code-only checkpoint `1da58a3`. The subsequently approved `docs/history/ANKI-v15.17-example-proposal.diff` changed only `ANKI_MASTER_PROMPT`, from `353471cbee66c759341ad8f4d857fa75ea4051744a52771ce780fcf172efc548` to `9d6c99229af067191df7b34d92c8ad98ff569870dd8f3be88634a5eb1a378b83`. After the failed pilot, the user approved the exact inverse in `docs/history/ANKI-v15.17-example-rollback.diff`. The current prompt and deliberately restored Anki baseline again have hash `353471cbee66c759341ad8f4d857fa75ea4051744a52771ce780fcf172efc548`. Both approvals are recorded in the baseline description. The other ten frozen constants retain their baseline. `Prompts.md` contains the restored source bytes.
